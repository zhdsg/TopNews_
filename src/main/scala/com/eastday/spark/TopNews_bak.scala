...
object TopNews_bak {
  def main(args: Array[String]) {
    ...
    //      pagePositionHistory.createOrReplaceTempView("page_position_history")
    //
    //      val newsPositionToVideoDataHistory=spark.read.jdbc(url,"news_position_to_video_data_history",properties)
    //      newsPositionToVideoDataHistory.createOrReplaceTempView("news_position_to_video_data_history")
    //
    //      val configTypeId=spark.read.jdbc(url,"config_type_id",properties)
    //      configTypeId.createOrReplaceTempView("config_type_id")
    //
    ...
    //        .filter(f=> !f.optype.equals("delete"))
    //
    //      unionDF.createOrReplaceTempView("position_table")
    //
    ...
    //      PagePositionFilter.createOrReplaceTempView("mysql_result_temp")
    //
